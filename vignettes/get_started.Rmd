...
What you do not find here is a theoretical description of the algorithms. For this purpose there is the **Under the hood vignette** and actually it is probably most often the better idea to start off with the theoretical one.
