...
In order to grasp what is going on under the hood a look at the **Under the hood vignette** is advised before starting to use the package. There the most important algorithms used during the risk measure estimation are explained. If this doesn't saturate your hunger for the theory behind the package you should take a look at [Sommer (2022)](https://mediatum.ub.tum.de/1658240).
